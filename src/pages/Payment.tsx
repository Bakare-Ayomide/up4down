                ...
                {ps.bank_name && (
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => copyToClipboard(ps.bank_name)} className="text-muted-foreground hover:text-primary"><Copy className="h-3.5 w-3.5" /></button>
                    </div>
                  </div>
                )}
                {ps.account_name && (
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => copyToClipboard(ps.account_name)} className="text-muted-foreground hover:text-primary"><Copy className="h-3.5 w-3.5" /></button>
                    </div>
                  </div>
                )}
                {ps.account_number && (
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => copyToClipboard(ps.account_number)} className="text-muted-foreground hover:text-primary"><Copy className="h-3.5 w-3.5" /></button>
                    </div>
                  </div>
                )}
                {ps.routing_number && (
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => copyToClipboard(ps.routing_number)} className="text-muted-foreground hover:text-primary"><Copy className="h-3.5 w-3.5" /></button>
                    </div>
                  </div>
                )}
                {ps.instructions && (
                  <p className="text-xs text-muted-foreground mt-2 border-t border-border pt-2">{ps.instructions}</p>
                )}
              </div>
            )}
