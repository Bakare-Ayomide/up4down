          ...
          <div>
            <Card className="p-6 border-border bg-card">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" disabled={submitting || !paymentRef.trim() || !screenshot} className="w-full bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl h-12 text-lg font-semibold shadow-[var(--shadow-glow)]">
                  {submitting ? (
